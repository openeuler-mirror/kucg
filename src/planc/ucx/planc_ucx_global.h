...
typedef void *(*ucg_planc_ucx_get_ucp_context_cb_t)(void *arg);

typedef void *(*ucg_planc_ucx_get_context_cb_t)();
...
typedef struct ucg_planc_ucx_oob_resource {
    ...
    ucg_planc_ucx_get_ucp_context_cb_t  get_ucp_context;
} ucg_planc_ucx_oob_resource_t;

typedef struct ucg_planc_ucx_export_resource {
    ucg_planc_ucx_get_context_cb_t      get_planc_context;
    ucg_planc_ucx_get_ucp_worker_cb_t   get_ucp_worker;
    ucg_planc_ucx_get_ucp_context_cb_t  get_ucp_context;
    ucg_planc_ucx_get_ucp_ep_cb_t       get_ucp_ep;
} ucg_planc_ucx_export_resource_t;

typedef struct ucg_planc_ucx {
    ucg_planc_t                         super;
    ucg_planc_ucx_oob_resource_t        oob_resource;
    ucg_planc_ucx_export_resource_t     export_resource;
} ucg_planc_ucx_t;
...
extern ucg_planc_ucx_t *ucg_planc_ucx_instance();
...
static inline ucp_context_h ucg_planc_ucx_get_oob_ucp_context()
{
    ucg_planc_ucx_t *planc_ucx = ucg_planc_ucx_instance();
    ucg_planc_ucx_oob_resource_t *ucx_oob_resource = &planc_ucx->oob_resource;
    return (ucp_context_h)ucx_oob_resource->get_ucp_context((void*)ucx_oob_resource->arg);
}
