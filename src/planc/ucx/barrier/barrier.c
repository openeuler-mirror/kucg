...
#define UCG_PLAN_UCX_PLAN_BARRIER_SCORE_1ST UCG_PLAN_UCX_PLAN_SCORE_0TH + 2
#define UCG_PLAN_UCX_PLAN_BARRIER_SCORE_2ND UCG_PLAN_UCX_PLAN_SCORE_0TH + 1
...
static ucg_plan_policy_t barrier_4_1[] = {
    {1,  {0, UCG_PLAN_RANGE_MAX}, UCG_PLAN_UCX_PLAN_BARRIER_SCORE_1ST},
...
static ucg_plan_policy_t barrier_4_32[] = {
    {6,  {0, UCG_PLAN_RANGE_MAX}, UCG_PLAN_UCX_PLAN_BARRIER_SCORE_1ST},
    {1,  {0, UCG_PLAN_RANGE_MAX}, UCG_PLAN_UCX_PLAN_BARRIER_SCORE_2ND},
    UCG_PLAN_LAST_POLICY,
};
static ucg_plan_policy_t barrier_4_64[] = {
    {7,  {0, UCG_PLAN_RANGE_MAX}, UCG_PLAN_UCX_PLAN_BARRIER_SCORE_1ST},
    {1,  {0, UCG_PLAN_RANGE_MAX}, UCG_PLAN_UCX_PLAN_BARRIER_SCORE_2ND},
    UCG_PLAN_LAST_POLICY,
};
...
static ucg_plan_policy_t barrier_LG_1[] = {
    {2,  {0, UCG_PLAN_RANGE_MAX}, UCG_PLAN_UCX_PLAN_BARRIER_SCORE_1ST},
    {1,  {0, UCG_PLAN_RANGE_MAX}, UCG_PLAN_UCX_PLAN_BARRIER_SCORE_2ND},
    UCG_PLAN_LAST_POLICY,
};
