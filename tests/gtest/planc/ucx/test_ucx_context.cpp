...
TEST_F(test_planc_ucx_config, read_user_config)
{
    ...
    setenv("UCG_PLANC_UCX_ALLREDUCE_FANIN_INTER_DEGREE", "5", 1);
    setenv("UCG_PLANC_UCX_BARRIER_FANIN_INTER_DEGREE", "6", 1);
...
TEST_F(test_planc_ucx_config, read_user_env_prefix)
{
    ...
    setenv("GTEST_UCG_PLANC_UCX_ALLREDUCE_FANIN_INTER_DEGREE", "5", 1);
    setenv("GTEST_UCG_PLANC_UCX_BARRIER_FANIN_INTER_DEGREE", "6", 1);
...
TEST_F(test_planc_ucx_config, read_invalid_args)
{
    ...
    ASSERT_EQ(ucg_planc_ucx_config_read(NULL, NULL, NULL), UCG_ERR_INVALID_PARAM);
    // filename is unsupported now
    ASSERT_EQ(ucg_planc_ucx_config_read(NULL, "unsupported_param", &config), UCG_ERR_UNSUPPORTED);
}
#endif
...
TEST_F(test_planc_ucx_config, modify)
{
    ...
    ASSERT_EQ(ucg_planc_ucx_config_modify(config, "BCAST_ATTR", "I:4R:0-4096I:5R:4096-5120"), UCG_OK);
    ASSERT_STREQ(cfg->plan_attr[UCG_COLL_TYPE_BCAST], "I:4R:0-4096I:5R:4096-5120");
...
TEST_F(test_planc_ucx_config, modify_non_exist)
{
    ...
    ASSERT_NE(ucg_planc_ucx_config_modify(config, "NON_EXIST", "value"), UCG_OK);
...
class test_planc_ucx_context : public testing::Test {
public:
    static void SetUpTestSuite()
    {
        stub::init();
    ...
    static ucg_planc_params_t m_params;
    static ucg_planc_config_h m_config;
};
ucg_planc_params_t test_planc_ucx_context::m_params = {NULL};
ucg_planc_config_h test_planc_ucx_context::m_config = NULL;
