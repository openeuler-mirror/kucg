...
ucg_group_params_t test_stub_group_params = {
    ...
    .oob_group = test_stub_group_oob_group,
};
                                          ...
                                          ucg_planc_context_h *context)
{
    ...
    *context = (ucg_planc_context_h)address[count++ % 2];
    return UCG_OK;
}
                                           ...
                                           ucg_planc_context_attr_t *attr)
{
    ...
    /* see test_stub_planc_context_init() */
                                       ...
                                       ucg_plans_t *plans)
{
    ...
    ucg_plan_params_t params = {
        ...
        .attr = {
            ...
            .vgroup = (ucg_vgroup_t*)planc_group,
            .score = 1,
        },
    };
...
ucg_status_t test_stub_plan_prepare(ucg_vgroup_t *vgroup,
                                    ...
                                    ucg_plan_op_t **op)
{
    if (!stub::call(stub::PLAN_PREPARE)) {
        return UCG_ERR_NO_RESOURCE;
    }

    ucg_plan_op_t *new_op = (ucg_plan_op_t *)malloc(sizeof(ucg_plan_op_t));
...
ucg_status_t test_stub_plan_op_trigger(ucg_plan_op_t *op)
{
    if (!stub::call(stub::PLAN_OP_TRIGGER)) {
        return UCG_ERR_INVALID_PARAM;
    }
    op->super.status = UCG_INPROGRESS;
    return UCG_OK;
}

ucg_status_t test_stub_plan_op_progress(ucg_plan_op_t *op)
{
    if (!stub::call(stub::PLAN_OP_PROGRESS)) {
...
ucg_status_t test_stub_plan_op_discard(ucg_plan_op_t *op)
{
    if (!stub::call(stub::PLAN_OP_DISCARD)) {
