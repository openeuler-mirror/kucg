...
TEST_F(test_ucg_group, create)
{
    ...
    // rank map may be optimized, cannot compare the fields other than size.
...
TEST_F(test_ucg_group, create_invalid_args)
{
    ...
    ucg_group_h group;
    ASSERT_EQ(ucg_group_create(NULL, &params, &group), UCG_ERR_INVALID_PARAM);
    ASSERT_EQ(ucg_group_create(m_context, NULL, &group), UCG_ERR_INVALID_PARAM);
    ASSERT_EQ(ucg_group_create(m_context, &params, NULL), UCG_ERR_INVALID_PARAM);
}

TEST_F(test_ucg_group, destroy_invalid_args)
{
...
TEST_F(test_ucg_group, create_no_required_field)
{
    ucg_group_h group;
    ...
    params.field_mask = 0;
    ASSERT_EQ(ucg_group_create(m_context, &params, &group), UCG_ERR_INVALID_PARAM);
...
TEST_F(test_ucg_group, create_invalid_field)
{
    ucg_group_h group;
    ucg_group_params_t params;
    memcpy(&params, &test_stub_group_params, sizeof(ucg_group_params_t));
