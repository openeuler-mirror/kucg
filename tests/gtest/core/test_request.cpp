...
ucg_group_h test_ucg_request::m_group;

TEST_F(test_ucg_request, bcast)
{
    const int count = 10;
    int buffer[count] = {1};
    ucg_rank_t root = 0;
...
TEST_F(test_ucg_request, start_multi_times)
{
    const int count = 10;
    int buffer[count] = {1};
    ucg_rank_t root = 0;
...
TEST_F(test_ucg_request, test_ok)
{
    const int count = 10;
    int buffer[count] = {1};
    ucg_rank_t root = 0;
...
TEST_F(test_ucg_request, cleanup_inprogress)
{
    const int count = 10;
    int buffer[count] = {1};
    ucg_rank_t root = 0;
...
TEST_F(test_ucg_request, with_context_progress)
{
    const int count = 10;
    int buffer[count] = {1};
    ucg_rank_t root = 0;
...
TEST_F(test_ucg_request, init_invalid_args)
{
    ucg_request_h request = nullptr;
...
TEST_F(test_ucg_request, test_invalid_args)
{
    ASSERT_EQ(ucg_request_test(NULL), UCG_ERR_INVALID_PARAM);
}

TEST_F(test_ucg_request, cleanup_invalid_args)
{
